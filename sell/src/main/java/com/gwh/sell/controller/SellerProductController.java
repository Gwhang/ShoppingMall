...
import com.gwh.sell.form.ProductForm;
...
public class SellerProductController {
    ...
    public ModelAndView list(@RequestParam(value = "page",defaultValue = "1")Integer page,
        ...
        Page<ProductInfo> productInfos = this.productInfoService.findAll(pageRequest);
        map.put("productInfoPage", productInfos);
        map.put("currentPage", page);
        map.put("size", size);
        ModelAndView mav =  new ModelAndView("product/list",map);
        return mav;
    }
